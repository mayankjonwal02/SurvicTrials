...
const SidebarAdmin = ({items , patient_trial_number }: {items: SidebarItem[] , patient_trial_number?: string}) => {
  const router = useRouter()
  return (
    <ScrollArea className=' rounded-3xl m-5 hidden md:flex flex-col h-[95%] w-[20%]  justify-start items-center backdrop-blur-xl bg-green-5/20' >
