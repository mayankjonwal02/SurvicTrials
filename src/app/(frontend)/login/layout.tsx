...
export default function loginLayout({
    ...
    return (
        ...
        <div className={cn("flex flex-col justify-center items-start h-fit w-screen bg-gradient-to-l from-green-2 from-10% via-green-4 via-60% to-green-3 to-90%", inter.className)}>
