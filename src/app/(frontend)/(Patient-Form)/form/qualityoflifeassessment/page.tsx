...
const Qualityoflifeassessment = () => {
    ...
    return (
        <div>
            ...
            <CustomForm questions={questions} handleSubmit={handleSubmit} buttontitle="Submit" formtitle="Quality of Life Assessment: FACTG/H&N/COST/FATIGUE Score" loading={false}/>
